...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Navbar */}
      <div
        className={`min-w-[540px] border borderbg bg-[#1A1A1A] flex justify-between max-lg:px-4 px-12 items-center py-[14px] max-lg:py-[17px] font-urbanist relative z-50 transition-all duration-300 ${
