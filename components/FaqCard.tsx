...
export default function FaqCard({ title, subtext }: CardProps) {
  return (
    <div className="relative border border-[#262626] bg-transparent w-[370px] max-lg:w-full rounded-xl px-[35px] max-lg:px-[25px] pt-7 pb-[24px] group overflow-hidden cursor-pointer">
      {/* Overlay */}
      ...
      <div className="relative z-10 max-lg:flex max-lg:flex-col max-lg:gap-8">
        ...
        <div className="flex text-[12px] relative gap-[7px] items-center">
          <p className="text-[13px] max-lg:text-[15px] mt-4 max-lg:mt-7 text-[#999999] leading-6">
            {subtext}
          </p>
        </div>
      </div>
