      ...
      <div className="border border-[#262626] p-[24px] max-lg:py-[30px] rounded-xl">
        ...
        <div className="mt-[10px] text-center">
          ...
          <div className="relative w-full flex">
            <div className="h-9 w-9 max-lg:h-16 max-lg:w-16 flex justify-center items-center bg-[#703BF7] rounded-full absolute right-3 max-lg:right-0 top-1/2 transform -translate-y-1/2">
              <AnimatedSendSvg />
            </div>
