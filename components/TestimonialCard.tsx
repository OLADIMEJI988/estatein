...
export default function TestimonialCard({
  ...
  return (
    <div className="relative border border-[#262626] cursor-pointer bg-transparent w-[370px] rounded-xl px-[38px] pt-7 pb-8 group overflow-hidden max-lg:min-w-[500px]">
      ...
      <div className="mt-[28px] relative z-10">
        ...
        <div className="flex text-[12px] relative gap-[7px] items-center">
          <p className="text-[12px] max-lg:text-[15px] mt-[1px] leading-6 h-[94px]">{subtext}</p>
        </div>
      </div>
